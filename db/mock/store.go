...
// Source: github.com/Sandhya-Pratama/simple-bank/db/sqlc (interfaces: Store)
...
import (
	...
	sqlc "github.com/Sandhya-Pratama/simple-bank/db/sqlc"
...
func (m *MockStore) CreateEntrie(arg0 context.Context, arg1 sqlc.CreateEntrieParams) (sqlc.Entry, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetEntrie(arg0 context.Context, arg1 int64) (sqlc.Entry, error) {
	m.ctrl.T.Helper()
